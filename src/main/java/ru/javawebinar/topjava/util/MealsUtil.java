...
public class MealsUtil {
    ...
    public static final List<Meal> MEALS = Arrays.asList(
        new Meal(LocalDateTime.of(2018, Month.NOVEMBER, 22, 7, 0), "Завтрак", 500),
        new Meal(LocalDateTime.of(2015, Month.MAY, 30, 20, 0), "Ужин", 500),
        new Meal(LocalDateTime.of(2018, Month.NOVEMBER, 21, 14, 0), "Обед", 1000),
        new Meal(LocalDateTime.of(2015, Month.MAY, 31, 20, 0), "Ужин", 510),
        new Meal(LocalDateTime.of(2018, Month.NOVEMBER, 22, 14, 0), "Обед", 1200),
        new Meal(LocalDateTime.of(2015, Month.MAY, 30, 13, 0), "Обед", 1000),
        new Meal(LocalDateTime.of(2015, Month.MAY, 31, 13, 0), "Обед", 500),
        new Meal(LocalDateTime.of(2018, Month.NOVEMBER, 21, 19, 0), "Ужин", 500),
        new Meal(LocalDateTime.of(2015, Month.MAY, 30, 10, 0), "Завтрак", 500),
        new Meal(LocalDateTime.of(2015, Month.MAY, 31, 10, 0), "Завтрак", 1000),
        new Meal(LocalDateTime.of(2018, Month.NOVEMBER, 21, 9, 0), "Завтрак", 1200),
        new Meal(LocalDateTime.of(2018, Month.DECEMBER, 1, 13, 0), "Обед", 900),
        new Meal(LocalDateTime.of(2018, Month.DECEMBER, 1, 18, 0), "Ужин", 1000),
        new Meal(LocalDateTime.of(2018, Month.DECEMBER, 2, 7, 30), "Завтрак", 600),
        new Meal(LocalDateTime.of(2018, Month.DECEMBER, 2, 12, 30), "Обед", 1100),
        new Meal(LocalDateTime.of(2018, Month.DECEMBER, 2, 19, 0), "Ужин", 1200)
    );
